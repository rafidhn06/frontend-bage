            ...
            setUser((prev) =>
                prev
                    ? {
                        ...
                        stats: {
                            ...prev.stats,
                            followers_count: prev.stats.followers_count + (prev.is_followed ? -1 : 1),
                        },
                    }
                    : null
            );
            toast.success(user.is_followed ? 'Berhenti mengikuti' : 'Mulai mengikuti');
        } catch (error) {
                            ...
                            <div className="flex gap-2">
                                <DropdownMenu modal={false}>
                                    ...
                                    <DropdownMenuContent align="end">
                                        <DropdownMenuItem onClick={handleCopyLink} className="flex items-center gap-2 px-3 py-2 font-bold">
                                            <Copy size={16} />
                                            Salin tautan
                                        </DropdownMenuItem>
                                    </DropdownMenuContent>
